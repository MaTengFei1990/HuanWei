...
public class SheShiHuiZongActivity extends CaiSlidingBackActivity implements TongJiAPI.TongJiAPIIF,View.OnClickListener {
    ...
    public int layoutResID() {
        return R.layout.activity_she_shi_hui_zong;
    }

    @Override
    public void findView() {
        mContext=this;
        SheShiHuiZList = (ListView) findViewById(R.id.SheShiHuiZongList);
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.iv_fanhui:
                ...
                break;
            case R.id.tv_home:
                Intent homeintent = new Intent(this, TuBiaoActivity.class);
    ...
    private class SheShiHuiZongAdapter extends BaseAdapter {
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            ...
            convertView.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    Intent intent = new Intent(SheShiHuiZongActivity.this, SheShiHuiZongDetailsActivity.class);
