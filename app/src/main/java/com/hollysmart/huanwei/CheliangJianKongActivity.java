...
public class CheliangJianKongActivity extends CaiSlidingBackActivity implements View.OnClickListener {

    private WebView webView;
    @Override
    public int layoutResID() {
        return R.layout.activity_cheliang_jian_kong;
    }
    ...
    public class JavaScriptinterface {
        ...
        public void startAcitvity(String id) {
            Intent intent = new Intent(CheliangJianKongActivity.this, XianluActivity.class);
