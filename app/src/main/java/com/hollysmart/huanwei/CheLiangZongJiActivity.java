...
public class CheLiangZongJiActivity extends CaiSlidingBackActivity implements View.OnClickListener {

    private WebView webView;

    @Override
    public int layoutResID() {
        return R.layout.activity_cheliang_zongji;
    }
    ...
    public class JavaScriptinterface {
        ...
        public void startAcitvity(String id) {
            Mlog.d("js交互时，传入的id====" + id);
            Intent intent = new Intent(CheLiangZongJiActivity.this, XianluActivity.class);
